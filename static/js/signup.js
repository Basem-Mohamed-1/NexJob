...
seeker.style.borderColor = "var(--primary)";
seeker.style.boxShadow = "7px 7px 15px -3px #057ae89f";
...
seeker.onclick = function () {
  ...
  document
    .querySelector("label[for='admin-signup-companyname']")
  ...
  document.getElementById("user_type_input").value = "seeker";
  Btn.disabled = true;
};

admin.onclick = function () {
  document
    .getElementById("admin-signup-companyname")
  ...
  admin.style.borderColor = "var(--primary)";
  admin.style.boxShadow = "7px 7px 15px -3px #057ae89f";
  ...
  // DISABLE BUTTON INCASE OF CHANGING THE FORM THAT I SUBMITTING IN
  document.getElementById("user_type_input").value = "admin";
  Btn.disabled = true;
};
